...
class ParetoFrontier:
    ...
    def estimate_accuracy_via_comparisons(self, new_node: Node) -> float:
        ...
        for existing_node in comparison_nodes:
            try:
                ...
                print(f"Comparison failed between {new_node.yaml_file_path} and {existing_node.yaml_file_path}: {e}")
                continue
    ...
    def plot_plans(self):
        ...
        non_frontier_nodes = [node for node in self.plans if node not in self.frontier_plans]
