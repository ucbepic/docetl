"""
The BaseOperation class is an abstract base class for all operations in the Motion framework. It provides a common structure and interface for various data processing operations.
"""
