...
# from motion.types import ValidatorAction, K, V, RK, RV
...
#         """
#         Implement this method to define how a key-value pair should be split into multiple pairs.
#         """
#         pass

#     def execute(self, key: K, value: V) -> Tuple[List[Tuple[RK, RV]], Dict]:
#         result = self.split(key, value)
#         return result, {}  # No additional info like prompts or responses
...
#     ) -> List[Tuple[RK, RV]]:
#         """
#         Override this method to implement custom correction logic.
#         By default, it returns the original output pairs.
#         """
#         return output_pairs
