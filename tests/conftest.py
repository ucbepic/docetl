...
@pytest.fixture
def test_map_operation_instance(map_config_with_batching, default_model, max_threads):
    return MapOperation(map_config_with_batching, default_model, max_threads)
