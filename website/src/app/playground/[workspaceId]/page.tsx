...
const CodeEditorPipelineApp: React.FC<{ workspaceId: string }> = ({ workspaceId }) => {
  ...
  const handleNew = () => {
    // Navigate to a new workspace
    const { v4: uuidv4 } = require("uuid");
    window.location.href = `/playground/${uuidv4()}`;
  };
      ...
      <div className="h-screen flex flex-col bg-gray-50">
        <div className={topBarStyles}>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will open a new empty workspace in a new URL.
                          Your current workspace will remain saved at this URL.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      toast({
                        ...
                        description:
                          "Your pipeline progress has been saved to the server.",
                        duration: 3000,
                      });
                    }}
          ...
          <div className="flex items-center gap-2">
            ...
            {isMounted && (
              <span className="text-sm text-gray-400 font-mono text-xs">{workspaceId}</span>
            )}
          </div>
          <div className={controlGroupStyles}>
            {isMounted && (
...
const WebSocketWrapper: React.FC<{ children: React.ReactNode; workspaceId: string }> = ({
  children,
  workspaceId,
}) => {
  return (
    <WebSocketProvider namespace={workspaceId}>
      {children}
    </WebSocketProvider>
  );
};
  ...
  return (
    <ThemeProvider>
      <PipelineProvider workspaceId={workspaceId}>
        <WebSocketWrapper workspaceId={workspaceId}>
          <CodeEditorPipelineApp workspaceId={workspaceId} />
        </WebSocketWrapper>
      </PipelineProvider>
    </ThemeProvider>
  );
