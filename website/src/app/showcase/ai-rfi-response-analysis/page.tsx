...
export default function AiRfiResponseAnalysisPage() {
  ...
  return (
    <>
      <Head>
        <title>
          AI Policy RFI Response Analysis | LLM Data Extraction Demo
        </title>
        <meta
          name="description"
          content="Interactive demo showing how DocETL uses LLMs to extract structured insights from 10,000 public responses to the U.S. AI RFI."
        />
        <meta
          name="keywords"
          content="ai policy analysis, llm data extraction, ai rfi, structured data from text, ai document analytics, gpt-4o, public comment analysis"
        />
        <meta
          property="og:title"
          content="AI Policy RFI Response Analysis | DocETL"
        />
        <meta
          property="og:description"
          content="See how AI extracts proposals, notable entities, demographics and more from thousands of policy responses."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://docetl.ai/showcase/ai-rfi-response-analysis"
        />
      </Head>
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                In February 2025, the U.S. Office of Science and Technology
                Policy requested public input on developing an AI Action Plan as
                directed by{" "}
                <Link
                ...
                . The government received over 10,000 responses from
                individuals, academia, industry, and other stakeholders.
              </p>
              <p className="text-sm text-muted-foreground">
                This demo showcases DocETL&apos;s capabilities by processing
                these responses to extract structured insights. Our pipeline
                uses gpt-4o-mini to analyze each submission to identify:
              </p>
              <ul className="text-sm text-muted-foreground list-disc pl-5 space-y-1">
                <li>
                  <span className="font-medium">Concrete proposals</span>:
                  Whether the response contains actionable policy suggestions
                </li>
                <li>
                  <span className="font-medium">Notable entity</span>: Whether
                  the submission comes from a notable entity (a well-known
                  individual, e.g., researcher, industry leader, celebrity,
                  etc., or organization) or other
                </li>
                <li>
                  <span className="font-medium">Age demographics</span>:
                  Estimated age bracket of the submitter
                </li>
                <li>
                  <span className="font-medium">Main topic</span>: Primary
                  concern discussed in the response
                </li>
                <li>
                  <span className="font-medium">Summary</span>: Concise summary
                  of the submission&apos;s key points
                </li>
              </ul>
              ...
              <div className="p-4 border border-yellow-300 bg-yellow-50 rounded-md mb-4">
                <p className="text-sm font-medium text-yellow-800">
                  <strong>Disclaimer:</strong> Please note that this analysis
                  may contain errors. Potential sources of inaccuracy include
                  OCR processing of the PDF documents and limitations in the LLM
                  agent used for data processing. This demonstration is for
