        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              ...
              tenant. DocETL pipelines can express this kind of semantic ranking
              in a few declarative steps. In this demo we take 179 lease
              agreements from the ALeaseBERT dataset and automatically{" "}
              <strong>rank them by the severity&nbsp;of “red flags”</strong>{" "}
            ...
            <p className="text-sm text-muted-foreground">
              ...
              then calls an LLM to rank the contracts by the severity of the red
              flags. Finally we render the results below: select any contract to
              read it with highlights, and click a red flag on the right to jump
              to its location in the text. Note that there's no "ground truth"
              ranking for severity; ideally the most severe red flags would be
              at the top of the list, and the bottom would be relatively benign.
            </p>
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm">
              ...
              <button
                ...
                className="inline-flex items-center text-blue-600 hover:underline"
              >
                Download Pipeline YAML <ExternalLink className="ml-1 h-4 w-4" />
              </button>
            </div>
            <div>
